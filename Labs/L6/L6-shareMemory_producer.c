/*
   ----- 48450 -- week 6 lab  Share-memory for Producer------ 
...
/* when do you compile this program please type - gcc L6-shareMemory-producer.c -o L6-producer -lrt where 'rt' -- real time library
*/
