/*
   ----- 48450 -- week 6 --- Share-memory for Consumer ------ 
...
/* when do you compile this program please type - gcc L6-shareMemory-consumer.c -o L6-consumer -lrt where 'rt' -- real time library
*/
